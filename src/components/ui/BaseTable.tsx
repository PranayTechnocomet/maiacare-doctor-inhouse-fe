...
export default function CommonTable<TData>({ data, columns }: CommonTableProps<TData>) {
  ...
  // 👉 Track which page button is active
  const [activePage, setActivePage] = useState<number>(5);

  // Just dummy list of pages
  const pages = [1, 2, 3, 4, 5, 99];
    ...
    <div className="table-responsive">
      ...
      <div className="pagination-container">
        ...
        <div className="pagination-controls">
          ...
          <button className="page-btn gap-2 align-items-center d-flex">Next
            <svg xmlns="http://www.w3.org/2000/svg" width="9" height="15" viewBox="0 0 9 15" fill="none">
