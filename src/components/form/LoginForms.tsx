    ...
    return (
        ...
        <div>
            <form onSubmit={handleFormSubmit}>
                ...
                <div className='pt-3'>
                    ...
                    >
                        ...
                        <span
                            ...
                            style={{ zIndex: 8 }}
                        >
                            {showPassword ? <BiShow size={20} className='passwored-eye-icon eye-color cursor-pointer-custom' /> : <BiHide size={20} className='passwored-eye-icon eye-color cursor-pointer-custom' />}
                ...
                <Button className='w-100 input-forgot-password-btn' type='submit'> Log In</Button>
